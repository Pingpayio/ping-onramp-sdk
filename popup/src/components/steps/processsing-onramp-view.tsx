...
import { FaClock, FaSpinner, FaCheckCircle, FaRegClock } from "react-icons/fa"; // Added FaSpinner, FaCheckCircle
  ...
  return (
    <div className="flex flex-col items-center h-full">
      ...
      <div className="w-full mt-4 mb-4">
        <div className="flex flex-col gap-2.5 bg-[#303030] border border-white/20 rounded-lg p-3">
      ...
      <div className="w-full flex flex-col gap-2 bg-[#303030] border border-white/20 rounded-lg p-4">
