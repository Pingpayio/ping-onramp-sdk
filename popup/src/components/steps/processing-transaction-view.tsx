  ...
  return (
    <div className="p-4 text-center" data-testid="processing-transaction-view">
      ...
      <div className="mt-4">
        {subStep === "depositing" && (
          <div
            data-testid="processing-substep-depositing"
        ...
        {subStep === "querying" && (
          <div
            data-testid="processing-substep-querying"
            className="text-blue-400"
          >
        ...
        {subStep === "signing" && (
          <div
            data-testid="processing-substep-signing"
            className="text-blue-400"
          >
        ...
        {subStep === "withdrawing" && (
          <div
            data-testid="processing-substep-withdrawing"
            className="text-blue-400"
          >
