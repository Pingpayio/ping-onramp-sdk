    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col">
          <Label htmlFor="country" className="text-sm text-white mb-2">
            Country
          </Label>
        ...
        <div className="flex flex-col">
          <Label htmlFor="mobileNumber" className="text-sm text-white mb-2">
            Mobile number
          </Label>
          <Input
            id="mobileNumber"
      ...
      <div className="flex flex-col">
        <Label htmlFor="nameOnCard" className="text-sm text-white mb-2">
          Name on card
        </Label>
        <Input
          id="nameOnCard"
      ...
      <div className="flex flex-col">
        <Label htmlFor="cardNumber" className="text-sm text-white mb-2">
          Card number
        </Label>
        <Input
          id="cardNumber"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col">
          <Label htmlFor="expiryDate" className="text-sm text-white mb-2">
            Expiry date
          </Label>
          <Input
            id="expiryDate"
        ...
        <div className="flex flex-col">
          <Label htmlFor="cvv" className="text-sm text-white mb-2">
            CVV
          </Label>
          <Input
            id="cvv"
      ...
      {/* Billing address */}
      <div className="flex flex-col">
        <Label htmlFor="billingAddress" className="text-sm text-white mb-2">
          Billing address
        </Label>
        <div className="relative">
          <Input
        ...
        <p className="text-xs text-white/40 mt-2 flex items-start gap-1">
          ...
          By tapping continue, you agree to our Terms and acknowledge that you
