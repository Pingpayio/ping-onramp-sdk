import { createFileRoute, lazyRouteComponent, notFound, createRootRoute, Outlet, HeadContent, Scripts, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
import { jsx, jsxs } from 'react/jsx-runtime';
import { RootProvider } from 'fumadocs-ui/provider/base';
import { TanstackProvider } from 'fumadocs-core/framework/tanstack';
import { createCompiler } from '@fumadocs/mdx-remote';
import { loader as loader$1 } from 'fumadocs-core/source';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/ebraem/workspace/pingpay/ping-onramp-sdk/docs/dist";
        const {
          promises: fs
        } = await import('node:fs');
        const path2 = await import('node:path');
        const filePath = path2.join(publicUrl, url);
    ...
    setItem: async (ctx, response) => {
      ...
      const publicUrl = "/Users/ebraem/workspace/pingpay/ping-onramp-sdk/docs/dist";
      const filePath = path2.join(publicUrl, url);
      await fs.mkdir(path2.dirname(filePath), {
        recursive: true
      });
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-B0dwJV-Z.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-Bf96IAJv.mjs');
    default:
...
function createServerRoute(__, __opts) {
  ...
  const route = {
    ...
    init: (opts) => {
      ...
      let path2 = isRoot ? rootRouteId : options.path;
      if (path2 && path2 !== "/") {
        path2 = trimPathLeft(path2);
      }
      const customId = options.id || path2;
      ...
      const fullPath = id === rootRouteId ? "/" : joinPaths([route.parentRoute.fullPath, path2]);
      route.path = path2;
      route.id = id;
...
const appCss = "/assets/app-DBufM_NE.css";
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { suppressHydrationWarning: true, children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "flex flex-col min-h-screen", children: [
      /* @__PURE__ */ jsx(TanstackProvider, { children: /* @__PURE__ */ jsx(RootProvider, { children }) }),
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$1 = () => import('./index-Dsl4MEkl.mjs');
...
const files = Object.entries(
  /* @__PURE__ */ Object.assign({
    "/content/index.mdx": __vite_glob_0_0,
    "/content/test.mdx": __vite_glob_0_1
  })
);
const virtualFiles = files.flatMap(([file, content]) => {
...
const $$splitComponentImporter = () => import('./_-BnA5QDav.mjs');
...
export { Route as R, createServerFn as a, createServerRpc as c, serverEntry as default, source as s };
