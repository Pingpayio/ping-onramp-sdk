      ...
      <div className="flex items-center justify-between ">
        ...
        <div className="py-2 gap-1 px-4 flex shrink-0 items-center justify-end text-[#FFFFFF99] text-xs">
          ...
          <button
            ...
            className="border gap-2 border-white/[0.18]! px-3! py-2! flex items-center rounded-full! bg-white/[0.08]! hover:bg-white/5! cursor-pointer transition-colors scale-90"
          >
            <img
              src={
